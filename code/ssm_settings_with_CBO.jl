...
# ----------------------------------------------------------------------------------------------------------------------
    ...
    d    = zeros(n+nR);
    d[3] = 1;
    Z    = [[ones(5); 0; ones(n-6)] [zeros(2,3); ones(3,3); zeros(1,3); ones(n-6,3)] [zeros(5); ones(n-5)] zeros(n) [zeros(6); 1 ./ σʸ[end-2:end]]];
    ...
    # Projections
    Z_ind[3:5, [1,2,3,4]] .= true; # Real               -> PC cycle, t, t-1, t-2, t-3
    Z_ind[7:n, [1,2,3,4]] .= true; # Prices             -> PC cycle, t, t-1, t-2, t-3
    Z_ind[7:n, 5]         .= true; # Prices             -> EP cycle, t (no lags)
